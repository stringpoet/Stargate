...
namespace StargateAPI.Migrations
{
    ...
    [Migration("20240630165215_Logging_Add_Timestamp")]
    partial class Logging_Add_Timestamp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StargateAPI.Business.Data.AstronautDetail", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CareerStartDate = new DateTime(2024, 6, 30, 12, 52, 14, 916, DateTimeKind.Local).AddTicks(6283),
            ...
            modelBuilder.Entity("StargateAPI.Business.Data.AstronautDuty", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DutyStartDate = new DateTime(2024, 6, 30, 12, 52, 14, 916, DateTimeKind.Local).AddTicks(6330),
                            DutyTitle = "Commander",
                            PersonId = 1,
                            Rank = "1LT"
                        });
            ...
            modelBuilder.Entity("StargateAPI.Business.Data.ExceptionLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("StargateAPI.Business.Data.SuccessLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
